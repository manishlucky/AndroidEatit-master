...
public class FoodList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // category=database.getReference("Food");
        ...
        {
            Toast.makeText(this,"category id is not empty",Toast.LENGTH_LONG).show();
            loadListFood(categoryId);
            Toast.makeText(this," load category id is empty",Toast.LENGTH_LONG).show();
        }
        else{
            Toast.makeText(this,"category id is empty",Toast.LENGTH_LONG).show();
        }
    ...
    private void loadListFood(String categoryId) {
...

        {
            ...
            @Override
            protected void populateViewHolder(FoodViewHolder viewHolder, Food model, int position) {
                Toast.makeText(FoodList.this,"load checking category id is empty",Toast.LENGTH_LONG).show();

                viewHolder.food_name.setText(model.getName());
                Toast.makeText(FoodList.this,"load checking category id is empty",Toast.LENGTH_LONG).show();
             Picasso.with(getBaseContext()).load(model.getImage()).into(viewHolder.food_image);
             final Food local=model;
                Toast.makeText(FoodList.this,"load list food is calling",Toast.LENGTH_LONG).show();
             viewHolder.setItemClickListner(new ItemClickListner() {
                 @Override
                 public void onClick(View view, int position, boolean isLongClick) {
                     Toast.makeText(FoodList.this,""+local.getName(),Toast.LENGTH_SHORT).show();//there is problem local.getName???????????
